...
class AimSvcServiceConnection extends IShizukuServiceConnection.Stub {
    ...
    public AimSvcServiceConnection(AimSvc.UserServiceArgs args) {
    ...
    public void died() {
        ...
        MAIN_HANDLER.post(() -> {
                    ...
                    connections.clear();
                    AimSvcServiceConnections.remove(this);
                }
        );
    }
}
