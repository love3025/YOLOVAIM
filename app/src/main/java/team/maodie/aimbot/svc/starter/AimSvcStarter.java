package team.maodie.aimbot.svc.starter;
...
import team.maodie.aimbot.svc.starter.util.IContentProviderCompat;
import rikka.hidden.compat.ActivityManagerApis;
import team.maodie.aimbot.svc.client.AimSvcApiConstants;
import team.maodie.aimbot.svc.server.UserService;

public class AimSvcStarter {

    private static final String TAG = "ShizukuServiceStarter";

    private static final String EXTRA_BINDER = "team.maodie.aimbot.svc.intent.extra.BINDER";
    ...
    private static final String USER_SERVICE_CMD_FORMAT = "(CLASSPATH='%s' %s%s /system/bin " +
            "--nice-name='%s' team.maodie.aimbot.svc.starter.AimSvcStarter " +
    ...
    private static boolean sendBinder(IBinder binder, String token, boolean retry) {
        String packageName = "team.maodie.aimbot";
        ...
        try {
            ...
            extra.putString(AimSvcApiConstants.USER_SERVICE_ARG_TOKEN, token);
