...
import team.maodie.aimbot.svc.adb.AdbProtocol.ADB_AUTH_RSAPUBLICKEY
import team.maodie.aimbot.svc.adb.AdbProtocol.ADB_AUTH_SIGNATURE
import team.maodie.aimbot.svc.adb.AdbProtocol.ADB_AUTH_TOKEN
import team.maodie.aimbot.svc.adb.AdbProtocol.A_AUTH
import team.maodie.aimbot.svc.adb.AdbProtocol.A_CLSE
import team.maodie.aimbot.svc.adb.AdbProtocol.A_CNXN
import team.maodie.aimbot.svc.adb.AdbProtocol.A_MAXDATA
import team.maodie.aimbot.svc.adb.AdbProtocol.A_OKAY
import team.maodie.aimbot.svc.adb.AdbProtocol.A_OPEN
import team.maodie.aimbot.svc.adb.AdbProtocol.A_STLS
import team.maodie.aimbot.svc.adb.AdbProtocol.A_STLS_VERSION
import team.maodie.aimbot.svc.adb.AdbProtocol.A_VERSION
import team.maodie.aimbot.svc.adb.AdbProtocol.A_WRTE
import team.maodie.aimbot.svc.ktx.logd
...
class AdbClient(private val host: String, private val port: Int, private val key: AdbKey) : Closeable {
    ...
    fun connect() {
        ...
        if (message.command == A_STLS) {
            if (AndroidBuild.VERSION.SDK_INT < 29) {
