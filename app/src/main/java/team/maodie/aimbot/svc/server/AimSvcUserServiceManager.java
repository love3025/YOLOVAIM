...
import team.maodie.aimbot.svc.starter.AimSvcStarter;
import rikka.hidden.compat.PackageManagerApis;
import rikka.hidden.compat.UserManagerApis;
import team.maodie.aimbot.svc.server.util.UserHandleCompat;

public class AimSvcUserServiceManager extends UserServiceManager {
    ...
    public AimSvcUserServiceManager() {
        super();
    }
    ...
    public String getUserServiceStartCmd(
        ...
        return AimSvcStarter.commandForUserService(
                appProcess,
                AimSvcService.getManagerApplicationInfo().sourceDir,
