...
import static team.maodie.aimbot.svc.client.AimSvcApiConstants.USER_SERVICE_ARG_COMPONENT;
import static team.maodie.aimbot.svc.client.AimSvcApiConstants.USER_SERVICE_ARG_DAEMON;
import static team.maodie.aimbot.svc.client.AimSvcApiConstants.USER_SERVICE_ARG_DEBUGGABLE;
import static team.maodie.aimbot.svc.client.AimSvcApiConstants.USER_SERVICE_ARG_NO_CREATE;
import static team.maodie.aimbot.svc.client.AimSvcApiConstants.USER_SERVICE_ARG_PROCESS_NAME;
import static team.maodie.aimbot.svc.client.AimSvcApiConstants.USER_SERVICE_ARG_REMOVE;
import static team.maodie.aimbot.svc.client.AimSvcApiConstants.USER_SERVICE_ARG_TAG;
import static team.maodie.aimbot.svc.client.AimSvcApiConstants.USER_SERVICE_ARG_USE_32_BIT_APP_PROCESS;
import static team.maodie.aimbot.svc.client.AimSvcApiConstants.USER_SERVICE_ARG_VERSION_CODE;
...
import team.maodie.aimbot.svc.aidl.IShizukuServiceConnection;
import rikka.hidden.compat.PackageManagerApis;
import team.maodie.aimbot.svc.client.AimSvcApiConstants;
import team.maodie.aimbot.svc.server.util.AbiUtil;
...
public abstract class UserServiceManager {
    ...
    public void attachUserService(IBinder binder, Bundle options) {
        ...
        String token = Objects.requireNonNull(options.getString(AimSvcApiConstants.USER_SERVICE_ARG_TOKEN), "token is null");
